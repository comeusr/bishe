...
def select_trend(t, step=6):
    ...
    best_relative_index = t-best_index
...
if __name__ == '__main__':
    ...
    test_df.to_csv(selected_path+r'\profit_window_best_trend-'+str(start)[0:10]+'(3).csv')
    oil_price = []
    print(test_df.head())
    ...
    price_comparison = pd.DataFrame({
        'Ture Price': price_df.loc[0:5531, 1],
        'Predict Price': oil_price
    })
    price_comparison.to_csv(r'C:\Users\Ziyi Wang\Desktop\bishe\realize wangyi\bishe\data\profit-windowed-priceComparison'+str(start)[0:10]+'(3).csv')
